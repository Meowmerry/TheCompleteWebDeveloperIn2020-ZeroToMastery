...
//2. Create another function that does the same thing, called checkDriverAge2() using Function Expression or Arrow function.
//BONUS: Instead of using the prompt. Now, only use console.log and make the checkDriverAge() function accept an argument of age, so that if you enter:

let checkDriverAge2 = (age) => {
  if(Number(age) < 18 ) {
    return console.log("Sorry, you are too yound to drive this car. Powering off");
  }else if(Number(age) > 18 ){
    return console.log("Powering On. Enjoy the ride!");
...
checkDriverAge2(12); //Sorry, you are too yound to drive this car. Powering off
